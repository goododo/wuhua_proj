...
group1 <- regress_cellcycle_harmony_pipe(group1, reso = 0.04)
table(group1$seurat_clusters)
...
group2 <- regress_cellcycle_harmony_pipe(group2, reso = 0.04)
table(group2$seurat_clusters)
...
group3 <- regress_cellcycle_harmony_pipe(group3, reso = 0.1)
table(group3$seurat_clusters)
...
group4 <- regress_cellcycle_harmony_pipe(group4, reso = 0.8)
table(group4$seurat_clusters)
