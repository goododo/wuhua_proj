...
pdf("2.Similarity_group1.pdf", width=6, height=2.5, onefile = F)
pheatmap::pheatmap(heatmap_mat, cluster_cols = F,
                   color = colorRampPalette(rev(brewer.pal(9, "Spectral")))(100), 
                   cluster_rows = F)
dev.off()

write.csv(heatmap_mat, "2.Similarity_group1.csv", quote = FALSE, row.names = TRUE)
save(list = c("train_mat", "test_mat", "Test_similarity", "heatmap_mat"),
     file = "2.Similarity_group1.RData")
...
group1_cellcyc <- FindClusters(group1_cellcyc, resolution = 0.055)
table(group1_cellcyc$seurat_clusters)
...
ggsave("1.UMAP_group1_cellcyc_reso0.55.pdf", plot = combined_plot, width = 12, height = 6)
...
ggsave("1.UMAP_group1_cellcyc_split_reso0.55.pdf", plot = combined_plot_split, width = 12, height = 6)
...
pdf("2.Similarity_group1_reso0.55.pdf", width=6, height=2.5, onefile = F)
pheatmap::pheatmap(heatmap_mat, cluster_cols = F,
                   color = colorRampPalette(rev(brewer.pal(9, "Spectral")))(100), 
                   cluster_rows = F)
dev.off()

write.csv(heatmap_mat, "2.Similarity_group1_reso0.55.csv", quote = FALSE, row.names = TRUE)
save(list = c("train_mat", "test_mat", "Test_similarity", "heatmap_mat"),
     file = "2.Similarity_group1_reso0.55.RData")
...
pdf("2.Similarity_group2.pdf", width=6, height=4, onefile = F)
pheatmap::pheatmap(heatmap_mat, cluster_cols = F,
                   color = colorRampPalette(rev(brewer.pal(9, "Spectral")))(100), 
                   cluster_rows = F)
dev.off()

write.csv(heatmap_mat, "2.Similarity_group2.csv", quote = FALSE, row.names = TRUE)
save(list = c("train_mat", "test_mat", "Test_similarity", "heatmap_mat"),
     file = "2.Similarity_group2.RData")
...
test_sub <- subset_by_group(test,  group.by = "seurat_clusters", n = 200)
...
pdf("2.Similarity_group3.pdf", width=5, height=2.5, onefile = F)
pheatmap::pheatmap(heatmap_mat, cluster_cols = F,
                   color = colorRampPalette(rev(brewer.pal(9, "Spectral")))(100), 
                   cluster_rows = F)
dev.off()
...
# 4. Group 4 ----
group4_harmony <- merge(x = ciToti10, 
...
## Regress ----
group4_harmony <- harmony_pipe(group4_harmony, reso = 0.83)
table(group4_harmony$seurat_clusters)

## UMAP ----
p1 <- DimPlot(group4_harmony, 
              reduction = "umap", 
              group.by = "orig.ident",
              pt.size = 0.5, 
              alpha = 0.6,
...
ggsave("1.UMAP_group4_harmony.pdf", plot = combined_plot, width = 12, height = 6)

p3 <- DimPlot(group4_harmony, reduction = "umap", split.by = "seurat_clusters",
              pt.size = 0.5, 
              alpha = 0.6,
              label = TRUE,
              repel = TRUE,
...
p4 <- DimPlot(group4_harmony, reduction = "umap", split.by = "orig.ident",
              pt.size = 0.5, 
              alpha = 0.6,
              label = TRUE,
              repel = TRUE,
...
ggsave("1.UMAP_group4_harmony_split.pdf", plot = combined_plot_split, width = 30, height = 6)

## Similarity ----
group4_ref <- readRDS("/home/lushi02/project/wuhua/ref/group4ref_E8.5.rds")
table(group4_ref$cell_type)
...
pdf("2.Similarity_group4.pdf", width=5, height=2.5, onefile = F)
pheatmap::pheatmap(heatmap_mat, cluster_cols = F,
                   color = colorRampPalette(rev(brewer.pal(9, "Spectral")))(100), 
                   cluster_rows = F)
dev.off()

write.csv(heatmap_mat, "2.Similarity_group4.csv", quote = FALSE, row.names = TRUE)
save(list = c("train_mat", "test_mat", "Test_similarity", "heatmap_mat"),
     file = "2.Similarity_group4.RData")
