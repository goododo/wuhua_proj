...
group1 <- FindClusters(group1, resolution = 0.03)
...
group2 <- harmony_pipe(group2, reso = 0.013)
group2 <- FindClusters(group2, resolution = 0.038)
...
group3 <- harmony_pipe(group3, reso = 0.055)
table(group3$seurat_clusters)
group3 <- FindClusters(group3, resolution = 0.13)
table(group3$seurat_clusters)
...
group4 <- harmony_pipe(group4, reso = 0.3)
table(group4$seurat_clusters)
group4 <- FindClusters(group4, resolution = 0.78)
table(group4$seurat_clusters)
